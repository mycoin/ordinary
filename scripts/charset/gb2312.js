...
String.prototype.encode = function()
{
	...
	for (var i = 0; i < this.length; i++)
	{
		...
		if (((c >= 65) && (c <= 90)) || ((c >= 97) && (c <= 122)) || ((c >= 46) && (c <= 57)))
		{
		...
		{
			for (var row = 0, o; o = String._aCharacters[row]; row++)
			{
				var col = o.indexOf(this.charAt(i));
				if (col >= 0)
				{
					s.push("%%%02X%%%02X".format(0xB0 + row, 0xA1 + col));
					break;
				}
			}
		}
...
String.prototype.count = function()
{
	...
	while (i--)
	{
		value += this.charCodeAt(i) < 256 ? 1 : 2;
	}
	return value;
}
